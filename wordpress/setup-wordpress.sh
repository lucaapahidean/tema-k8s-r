...
HTACCESS
    ...
    if [ "$PAGE_EXISTS" = "0" ] && [ -f "/tmp/integration-page.html" ]; then
        # Create the page
        ...
        echo "Integration page already exists or template not found"
    fi
    ...
    wp post create \
        ...
        --post_content="<h1>WordPress is running on Kubernetes!</h1><p>Node IP: $NODE_IP</p>" \
        --post_status=publish \
